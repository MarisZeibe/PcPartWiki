...
$users = [
        ...
        "user1@email.net" => "password",
        "user2@mail.com" => "1234",
];

$email = $password = $remember = $valid = '';
...
if(isset($_POST['login'])) {
    ...
    $valid = (array_key_exists($email, $users) && $password == $users[$email]) ?
                    '<div class="alert alert-success m-3" role="alert">Login successful</div>' :
                    '<div class="alert alert-danger m-3" role="alert">Incorrect email or password</div>';
                    ...
                    <div class="p-4">
                        ...
                        <form method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email" placeholder="email@example.com" name="email" value="<?php echo $email;?>">
                            </div>
                            <div class="form-group">
