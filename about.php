                    ...
                    <div class="p-4">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td>1</td>
                                <td>12 345 678</td>
                                <td>email.1@example.com</td>
                                <td>Adress1</td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>43 262 434</td>
                                <td>email.2@example.com</td>
                                <td>Adress2</td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>48 941 867</td>
                                <td>email.3@example.com</td>
                                <td>Adress3</td>
                            </tr>
                            </tbody>
                        </table>
                        <div style="height: 30vw"><iframe width="100%" height="100%" id="gmap_canvas" src="https://maps.google.com/maps?q=rigas%20valsts%20tehnikums&t=&z=13&ie=UTF8&iwloc=&output=embed"></iframe></div>
                    </div>
                </div>
            </div>
